...
| `parts` | *JSON Object* | Defines the product parts. Each key is a part's name built with color and material information. Example: ```javascript var parts = { "sole": { "material": "nappa", "color": "white" }, ... }``` |

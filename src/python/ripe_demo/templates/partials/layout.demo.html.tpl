...
{% block content %}
    ...
    {% block canvas %}
        <div id="canvas" class="canvas" data-url="{{ url|default('', True) }}"
            ...
            <img id="frame-6" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" />
            <img id="frame-top" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" />
        </div>
    {% endblock %}
{% endblock %}

...
ripe.OrbitalControls.prototype._updateDragRotations = function () {
    ...
    var diff;
    console.log(this._baseVerticalRot, this.mouseDeltaY)
...
ripe.OrbitalControls.prototype.rotationTransition = function (nextView, nextPosition, duration) {
    ...
    const transition = () => {
        ...
        this.currentHorizontalRot = ripe.linearTween(currentTime, this._baseHorizontalRot, finalXRotation, duration);
        this.currentVerticalRot = ripe.linearTween(currentTime, this._baseVerticalRot, finalYRotation, duration);
